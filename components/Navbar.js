export const Navbar = () => {
    return (
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" className="text-[#e7e8d9] bg-[#5B0F67] hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"><a className="text-base antialiased font-medium bg-clip-text bg-gradient-to-r to-lime-300 from-gray-100">Connect Wallet</a></button>
